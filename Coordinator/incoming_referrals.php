...
JOIN hospital h
ON r.sending_hospital_id=h.hospital_id
JOIN user d
...
<li>
<a href="incoming_referrals.php" class="active">
📥 Incoming Referrals
...
<p>Review referrals received by <?= htmlspecialchars($_SESSION['hospital_name']) ?>.</p>
</div>
...
<td><?= htmlspecialchars($row['sending_hospital']) ?></td>
...
<td class="actions">
<a href="view_incoming_referral.php?id=<?= $row['referral_id'] ?>" class="btn-view">
View
</a>
</td>
